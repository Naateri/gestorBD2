...
bool DataBase::interpret_query_d_index(str query, str& name, str_vec& values, str& column, str& name_index, str& num_col){
...
void DataBase::delete_data_index(str query){
